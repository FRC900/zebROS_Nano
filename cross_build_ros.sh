...
# docker run -it --user ubuntu -v /home/kjaget/zebROS_Nano:/home/ubuntu/zebROS_Nano -v ~/melodic_arm_cross_ws:/home/ubuntu/melodic_arm_cross_ws  frc900/zebros-2020-beta-dev /bin/bash
...
./src/catkin/bin/catkin_make_isolated --install --use-ninja -DCMAKE_INSTALL_PREFIX=$HOME/frc2019/roborio/arm-frc2019-linux-gnueabi/opt/ros/melodic -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=~/zebROS_Nano/zebROS_ws/rostoolchain.cmake -DCATKIN_ENABLE_TESTING=OFF
...
rm ~/zebROS_Nano/roscore_roborio.tar.bz2
tar -cjf ~/zebROS_Nano/roscore_roborio.tar.bz2 opt/ros/melodic
